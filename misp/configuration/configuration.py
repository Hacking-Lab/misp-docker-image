...
def update_instance():
    ...
    misp.enable_taxonomy(119)  # tlp
    misp.enable_taxonomy_tags(119)
...
lab0.add_org()
lab0.add_user(Role.admin, MailFormat.none)
...
lab6_a.add_user(Role.org_admin, MailFormat.full, 'lab6-org-A')
lab6_a.add_user(Role.publisher, MailFormat.full, 'lab6-org-A')
lab6_a.add_user(Role.investigator, MailFormat.full, 'lab6-org-A')
lab6_a.import_events(lab6_a.get_admin())
lab6_a.add_org('lab6-org-B')
lab6_a.add_user(Role.org_admin, MailFormat.full, 'lab6-org-B')
lab6_a.add_user(Role.publisher, MailFormat.full, 'lab6-org-B')
lab6_a.add_user(Role.investigator, MailFormat.full, 'lab6-org-B')

lab6_b = Lab(6, misp, Instance.B)
lab6_b.add_org('lab6-org-F')
lab6_b.add_user(Role.org_admin, MailFormat.full, 'lab6-org-F')
lab6_b.add_user(Role.publisher, MailFormat.full, 'lab6-org-F')
lab6_b.add_user(Role.investigator, MailFormat.full, 'lab6-org-F')
lab6_b.add_user(Role.sync, MailFormat.full, 'lab6-org-F')

lab6_e = Lab(6, misp, Instance.E)
lab6_e.add_org('lab6-org-E')
lab6_e.add_user(Role.org_admin, MailFormat.full, 'lab6-org-E')
lab6_e.add_user(Role.investigator, MailFormat.full, 'lab6-org-E')
...
lab7.add_user(Role.org_admin, MailFormat.org, 'lab7-org-A')
lab7.add_user(Role.investigator, MailFormat.org, 'lab7-org-A')
lab7.import_events(lab7.get_admin(0))

lab7.add_org('lab7-org-B')
lab7.add_user(Role.org_admin, MailFormat.org, 'lab7-org-B')
lab7.add_user(Role.investigator, MailFormat.org, 'lab7-org-B')
